...
// AFTER (consistent with all other handler)
func (h *AuthHandler) register(w http.ResponseWriter, r *http.Request)
```
...
**Files to Change:**
- `internal/infrastructure/pkg/handlers/auth/handler.go` (method names + Routes())
...
**Files to Change:**
- `internal/infrastructure/pkg/handlers/savedcard/crud.go` (saveCard method)
...
4. [BaseHandler](../internal/infrastructure/pkg/handlers/base.go) - Base handler implementation
