...
| File | Reason | Size |
|------|--------|------|
| `internal/adapters/http/handlers/auth/handler_v2.go.unused` | Alternative implementation never used | ~200 LOC |
| `internal/adapters/http/handlers/payment/handler_optimized.go.unused` | Experimental optimization never adopted | ~150 LOC |
| `internal/adapters/http/handlers/book/handler_optimized.go.unused` | Alternative implementation never used | ~180 LOC |
| `internal/infrastructure/app/app_v2.go.unused` | Alternative bootstrap never adopted | ~250 LOC |
...
**Files Modified:**
- `internal/adapters/http/handlers/book/handler.go` - Struct + constructor
- `internal/adapters/http/handlers/book/crud.go` - 5 use case calls
- `internal/adapters/http/handlers/book/query.go` - 2 use case calls
- `internal/adapters/http/handlers/auth/handler.go` - Struct + constructor + 4 use case calls
- `internal/adapters/http/handlers/payment/handler.go` - Struct + constructor
- `internal/adapters/http/handlers/payment/initiate.go` - 2 use case calls
- `internal/adapters/http/handlers/payment/manage.go` - 2 use case calls
- `internal/adapters/http/handlers/payment/query.go` - 2 use case calls
- `internal/adapters/http/handlers/payment/callback.go` - 1 use case call
- `internal/adapters/http/handlers/savedcard/handler.go` - Struct + constructor
- `internal/adapters/http/handlers/savedcard/crud.go` - 3 use case calls
- `internal/adapters/http/handlers/savedcard/manage.go` - 1 use case call
- `internal/adapters/http/handlers/reservation/handler.go` - Struct + constructor
- `internal/adapters/http/handlers/reservation/crud.go` - 3 use case calls
- `internal/adapters/http/handlers/reservation/query.go` - 1 use case call
- `internal/adapters/http/handlers/receipt/handler.go` - Struct + constructor + 3 use case calls
- `internal/adapters/http/handlers/author/handler.go` - Struct + constructor + 1 use case call
- `internal/adapters/http/handlers/member/handler.go` - Struct + constructor + 2 use case calls
...
**Before:**
```go
// Convert to legacy container for backward compatibility with handlers
