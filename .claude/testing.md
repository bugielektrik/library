...
```go
// internal/adapters/repository/mocks/repository.go
package mocks
...
mockgen -source=internal/domain/book/repository.go \
    -destination=internal/adapters/repository/mocks/repository.go \
    -package=mocks
```
...
```go
// internal/adapters/repository/postgres/book_test.go
