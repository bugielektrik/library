...
Created `internal/infrastructure/pkg/repository/postgres/generic.go` with 7 reusable helper functions:
...
- Implementation: `internal/infrastructure/pkg/repository/postgres/generic.go`
- Tests: `internal/infrastructure/pkg/repository/postgres/generic_test.go`
