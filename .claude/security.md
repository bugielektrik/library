...
grep -r "SELECT.*+.*\"" --include="*.go" internal/adapters/repository/
grep -r "INSERT.*+.*\"" --include="*.go" internal/adapters/repository/
grep -r "UPDATE.*+.*\"" --include="*.go" internal/adapters/repository/
grep -r "DELETE.*+.*\"" --include="*.go" internal/adapters/repository/
...
if grep -r "SELECT.*+.*\"" --include="*.go" ./internal/adapters/repository/ 2>/dev/null; then
