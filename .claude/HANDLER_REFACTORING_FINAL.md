...
### File: `internal/adapters/http/dto/saved_card.go`
...
- ✅ All use DTOs from `internal/adapters/http/dto`
...
- ✅ All DTOs in `internal/adapters/http/dto`
...
| File | Changes | Status |
|------|---------|--------|
| `internal/adapters/http/handlers/auth/handler.go` | 9 changes (4 renames + Routes update) | ✅ |
| `internal/adapters/http/dto/saved_card.go` | +6 lines (new DTO) | ✅ |
| `internal/adapters/http/handlers/savedcard/crud.go` | 4 changes (validation + imports) | ✅ |
| `internal/adapters/http/router.go` | -9 lines (simplified auth routing) | ✅ |
...
5. [BaseHandler](../internal/adapters/http/handlers/base.go) - Base handler implementation
