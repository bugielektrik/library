...
func TestUseCaseLogger(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := logutil.WithLogger(context.Background(), baseLogger)

			// Create logger using utility
			logger := logutil.UseCaseLogger(ctx, tt.domain, tt.operation)
...
func TestHandlerLogger(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Create logger
			logger := logutil.HandlerLogger(ctx, tt.handlerName, tt.methodName)
...
func TestRepositoryLogger(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Create logger
			logger := logutil.RepositoryLogger(ctx, tt.repositoryName, tt.operation)
...
func TestLoggerIntegration(t *testing.T) {
	...
	// Test UseCaseLogger
	useCaseLogger := logutil.UseCaseLogger(ctx, "test", "test_operation")
	useCaseLogger.Info("use case message")

	// Test HandlerLogger
	handlerLogger := logutil.HandlerLogger(ctx, "test_handler", "test_method")
	handlerLogger.Info("handler message")

	// Test RepositoryLogger
	repoLogger := logutil.RepositoryLogger(ctx, "test_repo", "test_operation")
