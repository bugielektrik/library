// Package reservationops implements use cases for book reservation operations.
//
...
//   - member.Repository: To verify member eligibility
//
// Example usage:
//
...
//
// Architecture:
//   - Package name uses "ops" suffix to avoid conflict with domain reservation package
//   - Reservation queue logic in reservation.Service
