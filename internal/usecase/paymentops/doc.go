...
// (epayment.kz) and manages payment lifecycle from initiation to completion.
//
...
//
// Dependencies:
//   - payment.Repository: For payment record persistence
//   - payment.Service: For payment validation and receipt generation
//   - payment.Gateway: External payment gateway adapter (epayment.kz)
...
//   - Gateway adapter implements payment.Gateway interface
