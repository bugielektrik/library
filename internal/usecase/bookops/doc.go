// Package bookops implements use cases for book management operations.
//
...
// Example usage:
//
//	createUC := bookops.NewCreateBookUseCase(repo, cache, service)
//	response, err := createUC.Execute(ctx, bookops.CreateBookRequest{
//	    Name:    "Clean Code",
//	    Genre:   "Programming",
//	    ISBN:    "978-0132350884",
...
//
// Architecture:
//   - Package name uses "ops" suffix to avoid conflict with domain book package
