// Package subops implements use cases for subscription management operations.
//
...
// Example usage:
//
//	subscribeUC := subops.NewSubscribeMemberUseCase(memberRepo, memberService, paymentGateway)
//	response, err := subscribeUC.Execute(ctx, subops.SubscribeRequest{
