...
func (uc *PayWithSavedCardUseCase) validateSavedCard(
	...
	if err != nil {
		...
		return domain.SavedCard{}, errors.ErrNotFound.
	...
	if !savedCard.CanBeUsed() {
		...
		return domain.SavedCard{}, errors.NewError(errors.CodeValidation).
...
func (uc *PayWithSavedCardUseCase) createPaymentRecord(
	...
	if err != nil {
		...
		return domain.Payment{}, errors.Database("database operation", err)
	}
...
func (uc *PayWithSavedCardUseCase) chargeCardViaGateway(
	...
	if err != nil {
		...
		return domain.Payment{}, errors.External("payment gateway", err)
	}
