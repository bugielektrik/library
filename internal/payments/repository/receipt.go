...
func (r *ReceiptRepository) GetByID(id string) (domain.Receipt, error) {
	query := `
...
func (r *ReceiptRepository) GetByPaymentID(paymentID string) (domain.Receipt, error) {
	query := `
		SELECT id, payment_id, receipt_number, member_id, amount, currency,
		       payment_type, payment_method, transaction_id, payment_date, receipt_date,
		       status, description, member_name, member_email, card_mask,
...
func (r *ReceiptRepository) GetByReceiptNumber(receiptNumber string) (domain.Receipt, error) {
	query := `
		SELECT id, payment_id, receipt_number, member_id, amount, currency,
		       payment_type, payment_method, transaction_id, payment_date, receipt_date,
		       status, description, member_name, member_email, card_mask,
...
func (r *ReceiptRepository) ListByMemberID(memberID string) ([]domain.Receipt, error) {
	query := `
		SELECT id, payment_id, receipt_number, member_id, amount, currency,
		       payment_type, payment_method, transaction_id, payment_date, receipt_date,
		       status, description, member_name, member_email, card_mask,
