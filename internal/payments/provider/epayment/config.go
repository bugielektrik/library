...
// LoadConfigFromEnv loads edomain.kz configuration from environment variables.
func LoadConfigFromEnv() (*Config, error) {
	...
	if environment == "prod" {
		...
		config.OAuthURL = "https://test-epay-oauth.edomain.kz/oauth2/token"
		config.BaseURL = "https://test-epay-api.edomain.kz"
		config.WidgetURL = "https://test-epay.edomain.kz/redesign-payform/payment-api.js"
	}
