// Package http provides HTTP handlers for book reservation operations.
//
...
//
// Related Packages:
//   - Use Cases: internal/reservations/operations/ (reservation business logic)
//   - Domain: internal/reservations/domain/ (reservation entity and service)
//   - DTOs: internal/adapters/http/dto/reservation.go (request/response types)
//
// Example Usage:
//
//	reservationHandler := reservationhttp.NewReservationHandler(useCases, validator)
