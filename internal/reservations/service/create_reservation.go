...
//   - Similar pattern: internal/books/service/create_book.go (simple CRUD)
//   - HTTP handler: internal/reservations/handler/handler.go
...
//   - Test: internal/reservations/service/create_reservation_test.go
