// Package service implements use cases for book management service.
//
// This package orchestrates book-related business workflows by coordinating
// domain entities, service, and repositories. Each use case represents a
...
// Example usage:
//
//	createUC := service.NewCreateBookUseCase(repo, cache, service)
//	response, err := createUC.Execute(ctx, service.CreateBookRequest{
//	    Name:    "Clean Code",
//	    Genre:   "Programming",
//	    ISBN:    "978-0132350884",
...
//
// Architecture:
//   - Package name "service" to represent book-specific operations within the books bounded context
