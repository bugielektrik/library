...
func (h *BookHandler) list(w http.ResponseWriter, r *http.Request) {
	...
	// Execute usecase
	result, err := h.useCases.Book.ListBooks.Execute(ctx, operations.ListBooksRequest{})
	if err != nil {
...
func (h *BookHandler) listAuthors(w http.ResponseWriter, r *http.Request) {
	...
	// Execute usecase
	result, err := h.useCases.Book.ListBookAuthors.Execute(ctx, operations.ListBookAuthorsRequest{BookID: id})
	if err != nil {
		h.RespondError(w, r, err)
		return
	}
