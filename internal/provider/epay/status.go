...
func GetDescriptionTitle(reasonCode, lang string) (description string) {
	...
	// fallback to the "2660" translation if the reason code is unknown.
...
func GetStatusTitle(statusName, lang string) string {
	...
	// fallback to the "REJECT" translation if the status is unknown.
