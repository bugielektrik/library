...
// ValidatorAdapter adapts the middleware.Validator to work with generic handler
...
// NoValidation returns nil validator for handler that don't need validation
