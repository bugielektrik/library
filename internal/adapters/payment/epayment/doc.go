// Package epayment provides integration with the epayment.kz payment gateway.
//
// This package implements the PaymentGateway interface for Kazakhstan's epayment.kz
...
// epayment.kz API. It implements automatic token management with caching and refresh,
...
//
//	gateway := epayment.NewGateway(config, logger)
...
//   - ClientID and ClientSecret: OAuth credentials from epayment.kz
...
// # Testing
//
// For testing, use the test environment configuration provided by epayment.kz.
