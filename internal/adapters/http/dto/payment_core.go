...
//   - AuthToken: OAuth token for gateway widget authentication
...
// the payment widget or redirect the user to the payment gateway.
...
// It includes all payment transaction details including gateway-specific information,
