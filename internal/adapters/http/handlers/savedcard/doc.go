// Package savedcard provides HTTP handlers for saved payment card management.
//
...
//   - Store payment methods securely via gateway tokenization
...
//   - Only gateway tokens (references) are stored
//   - PCI DSS compliance is gateway's responsibility
