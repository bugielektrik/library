// Package book provides HTTP handlers for book management operations.
//
...
//
// Related Packages:
//   - Use Cases: internal/usecase/bookops/ (book business logic)
//   - Domain: internal/domain/book/ (book entity, service, and repository interface)
//   - DTOs: internal/adapters/http/dto/book.go (request/response types)
//   - Cache: internal/adapters/cache/ (book caching for GET operations)
//
// Example Usage:
//
//	bookHandler := book.NewBookHandler(useCases, validator)
