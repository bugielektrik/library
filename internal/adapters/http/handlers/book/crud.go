...
func (h *BookHandler) get(w http.ResponseWriter, r *http.Request) {
	...
	// Execute usecase
	result, err := h.useCases.Book.GetBook.Execute(ctx, bookops.GetBookRequest{ID: id})
	if err != nil {
		h.RespondError(w, r, err)
		return
	}
...
func (h *BookHandler) update(w http.ResponseWriter, r *http.Request) {
	...
	// Execute usecase
	response, err := h.useCases.Book.UpdateBook.Execute(ctx, bookops.UpdateBookRequest{
		ID:      id,
		Name:    req.Name,
		Genre:   req.Genre,
		ISBN:    req.ISBN,
...
func (h *BookHandler) delete(w http.ResponseWriter, r *http.Request) {
	...
	// Execute usecase
	response, err := h.useCases.Book.DeleteBook.Execute(ctx, bookops.DeleteBookRequest{ID: id})
	if err != nil {
		h.RespondError(w, r, err)
		return
	}
