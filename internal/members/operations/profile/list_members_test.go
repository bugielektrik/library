	...
	tests := []struct {
	...
	}{
		{
			...
			validateFunc: func(t *testing.T, resp ListMembersResponse) {
				...
				helpers.AssertEqual(t, domain.RoleAdmin, resp.Members[2].Role)
		...
		},
		{
			...
			validateFunc: func(t *testing.T, resp ListMembersResponse) {
				helpers.AssertEqual(t, 3, resp.Total)
				helpers.AssertEqual(t, domain.RoleAdmin, resp.Members[0].Role)
				helpers.AssertEqual(t, domain.RoleUser, resp.Members[1].Role)
				helpers.AssertEqual(t, domain.RoleUser, resp.Members[2].Role)
			},
		},
		{
