// Package auth implements authentication and authorization use cases.
//
...
// generation, password hashing, and member repository service.
//
...
// Example usage:
//
//	loginUC := auth.NewLoginMemberUseCase(memberRepo, tokenService, passwordService)
//	response, err := loginUC.Execute(ctx, auth.LoginRequest{
...
//   - Token service injected from infrastructure layer
