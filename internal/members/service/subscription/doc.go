// Package subscription implements use cases for subscription management service.
//
...
// Subscriptions enable members to access library service and borrow books.
//
...
//   - Payment processing via payment provider adapter
