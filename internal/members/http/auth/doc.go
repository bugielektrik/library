// Package auth provides HTTP handlers for authentication and authorization operations.
//
...
//
// All endpoints follow the handler patterns defined in the parent handlers package.
...
//   - Infrastructure: internal/infrastructure/auth/ (JWT + password services)
//
// Example Usage:
//
