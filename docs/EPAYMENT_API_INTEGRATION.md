...
**Implementation**:
- Handler: `internal/adapters/http/handlers/payment.go:handleCallback()`
- Use Case: `internal/usecase/paymentops/handle_callback.go`
- DTO: `internal/adapters/http/dto/payment.go:PaymentCallbackRequest`
...
logger.Warn("failed to check status with gateway") // Recoverable
